...
class Plateau : PlateauProtocol {
	...
	*/
    ...
    func retirer_plateau(_ carte: Carte) throws -> CarteProtocol{
	...
	func position_carte(_ carte: Carte) -> (Int, Int){
	...
	func tuer(_ carte: Carte) throws {
	...
	func est_a_portee(_ p_def: Plateau, _ c_att: Carte, _ c_def: Carte) -> Bool {
